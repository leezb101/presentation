var B=Object.defineProperty;var W=(g,e,t)=>e in g?B(g,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):g[e]=t;var m=(g,e,t)=>W(g,typeof e!="symbol"?e+"":e,t);import{i as V,a as k,x as s,E as N,T as F}from"./lit-DPiGUO4P.js";import{g as i}from"./gsap-CH_iu5NA.js";import{C as j,r as Q}from"./chart-Cbdzloa0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=t(r);fetch(r.href,n)}})();class z extends V{constructor(){super(),this.isAnimating=!1}safeSetTimeout(e,t){return setTimeout(()=>{this.isConnected&&e()},t)}safeRequestAnimationFrame(e){return requestAnimationFrame(()=>{this.isConnected&&e()})}}m(z,"styles",k`
    :host {
      display: block;
    }
    /* layer: preflights */
...
.ease-out{transition-timing-function:cubic-bezier(0, 0, 0.2, 1);} .roadmap-item {
  ...
  `);customElements.define("roadmap-component",_);class E extends z{constructor(){super(),this.currentView="status"}firstUpdated(){this.safeRequestAnimationFrame(()=>{this.currentView==="status"?this.initializeStatusAnimations():this.currentView==="painpoints"&&this.initializePainPointsAnimations()})}renderStatusView(){return s`
      <div
    ...
    `}}m(E,"properties",{currentView:{type:String}}),m(E,"styles",k`
    /* layer: preflights */
*,::before,::after{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgb(0 0 0 / 0);--un-ring-shadow:0 0 rgb(0 0 0 / 0);--un-shadow-inset: ;--un-shadow:0 0 rgb(0 0 0 / 0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgb(147 197 253 / 0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}::backdrop{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgb(0 0 0 / 0);--un-ring-shadow:0 0 rgb(0 0 0 / 0);--un-shadow-inset: ;--un-shadow:0 0 rgb(0 0 0 / 0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgb(147 197 253 / 0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}
/* layer: default */
.pointer-events-none{pointer-events:none;}
    ...
    `}renderPhotosTab(){const e=this.getPhotoGallery();return s`
      <div class="space-y-8">
        ...
        <div class="grid md:grid-cols-3 gap-6">
          ${[{category:"现场调研",count:2,icon:"mdi:hard-hat",color:"blue"},{category:"质量管控",count:2,icon:"mdi:package-variant",color:"green"},{category:"协调沟通",count:1,icon:"mdi:account-group",color:"purple"}].map(t=>s`
              <div
    ...
    `}renderResultsTab(){const e=this.getSurveyData();return s`
      <div class="space-y-8">
        ...
        >
          ...
          <div class="grid md:grid-cols-4 gap-6">
            ${[{label:"调研周期",value:"3",unit:"周",icon:"mdi:calendar",color:"blue"},{label:"参与人员",value:"9",unit:"人",icon:"mdi:account-group",color:"green"},{label:"会议次数",value:"5",unit:"次",icon:"mdi:calendar-text",color:"orange"},{label:"照片记录",value:"5",unit:"张",icon:"mdi:camera",color:"purple"}].map(t=>s`
                <div class="text-center">
                  <div
            ...
            <div class="flex items-center justify-between relative">
              ${[{phase:"现状调研",status:"completed",color:"green",icon:"mdi:magnify"},{phase:"需求确认",status:"completed",color:"green",icon:"mdi:clipboard-check"},{phase:"方案设计",status:"current",color:"blue",icon:"mdi:drawing"},{phase:"试点建设",status:"pending",color:"gray",icon:"mdi:flask"},{phase:"推广应用",status:"pending",color:"gray",icon:"mdi:rocket"}].map((t,a)=>s`
                  <div class="flex flex-col items-center relative z-10">
                    <div
                      class="w-16 h-16 bg-${t.color}-500 rounded-full flex items-center justify-center mb-3 ${t.status==="current"?"ring-8 ring-blue-300 animate-pulse":""}"
                    >
                      <iconify-icon
                        icon="${t.icon}"
                        class="text-2xl text-white"
...
.ring-blue-300{--un-ring-opacity:1;--un-ring-color:rgb(147 197 253 / var(--un-ring-opacity)) /* #93c5fd */;}
